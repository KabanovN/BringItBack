...
/* harmony import */ var _modules_sliders_miniSliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliders/miniSliders */ "./src/js/modules/sliders/miniSliders.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_sliders_miniSliders__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_sliders_miniSliders__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  feedSlider.init();
  new _modules_playVideos__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay').init();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Differences; });
...
function () {
  ...
  _createClass(Forms, [{
    ...
    key: "checkEmailInputs",
    value: function checkEmailInputs() {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (evt) {
          ...
          statusMessage.textContent = _this.status.loading;
          form.parentNode.append(statusMessage);
          var formData = new FormData(form);

          _this.postData(formData, _this.path).then(function (res) {
            console.log(res);
            statusMessage.textContent = _this.status.success;
          }).catch(function () {
            statusMessage.textContent = _this.status.failure;
          }).finally(function () {
            _this.clearInputs();
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          ...
          var blockedElement = btn.closest('.module__video-item').nextElementSibling;
        ...
        btn.addEventListener('click', function () {
          ...
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            _this.activeBtn = btn; //для метода onPlayerStateChange

            if (_this.player) {
              _this.overlay.style.display = 'flex'; // ссылка на видео указана в data-url кнопки

              if (_this.path !== btn.getAttribute('data-url')) {
                _this.path = btn.getAttribute('data-url'); //функ-я загрузки и воспр-я указанного видео (YT Player API)
    ...
    value: function bindCloseBtn() {
      ...
      this.close.addEventListener('click', function () {
        ...
        _this2.player.stopVideo(); //для сброса воспроизведения
    ...
    value: function createPlayer(url) {
      this.player = new YT.Player('frame', {
        ...
        videoId: "".concat(url),
        events: {
          'onStateChange': this.onPlayerStateChange // чтобы контекст this не терялся, т.к. запуск идёт в экземпляре класса YT.Player,
    ...
    value: function onPlayerStateChange(event) {
      try {
        ...
        var blockedElement = this.activeBtn.closest('.module__video-item').nextElementSibling; // создаем элемент активной кнопки воспроизведения, копируя svg

        var playBtn = this.activeBtn.querySelector('svg').cloneNode(true); // event.data = 0 => согласно документации API - воспроизведение видео завершено
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./slider */ "./src/js/modules/sliders/slider.js");
...
/***/ "./src/js/modules/sliders/miniSliders.js":
/*!***********************************************!*\
  !*** ./src/js/modules/sliders/miniSliders.js ***!
  \***********************************************/
/*! exports provided: default */
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass));
  }

  _createClass(MiniSlider, [{
    key: "activateSlides",
    value: function activateSlides() {
      var _this = this;
      ...
      this.next.addEventListener('click', function () {
        ...
        _this2.slides.forEach(function (slide) {
          if (slide.tagName === 'BUTTON') {
            _this2.container.append(slide);
          }
        });

        _this2.container.append(_this2.slides[0]);

        _this2.activateSlides();
      });
      this.prev.addEventListener('click', function () {
        _this2.slides.forEach(function (slide) {
          if (slide.tagName === 'BUTTON') {
            _this2.container.insertBefore(slide, _this2.slides[1]);
          }
        });

        _this2.container.insertBefore(_this2.slides[_this2.slides.length - 1], _this2.slides[0]);
